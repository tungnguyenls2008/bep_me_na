                    ...
                    <div class="card-body">
                        <div class="float-end mt-2">
                            ...
                            <div id="total-revenue-chart">
                                ...
                                Tổng doanh số hiện tại là <b>{{number_format($sum_sale)}}</b>
                            </div>
                        </div>
                        ...
                        <div class="report-container">
                            <style>
                                .report-container {
                                    ...
                                    @case('01d')        background: url({{asset('images/w_clear_sky.gif')}});
                                    @case('01n')        background: url({{asset('images/w_clear_sky.gif')}});
                                    @case('02d')        background: url({{asset('images/w_few_cloud.gif')}});
                                    @case('02n')        background: url({{asset('images/w_few_cloud.gif')}});
                                    @case('03d')        background: url({{asset('images/w_scattered_clouds.gif')}});
                                    @case('03n')        background: url({{asset('images/w_scattered_clouds.gif')}});
                                    @case('04d')        background: url({{asset('images/w_broken_clouds.gif')}});
                                    @case('04n')        background: url({{asset('images/w_broken_clouds.gif')}});
                                    @case('09d')        background: url({{asset('images/w_shower_rain.gif')}});
                                    @case('09n')        background: url({{asset('images/w_shower_rain.gif')}});
                                    @case('10d')        background: url({{asset('images/w_rain.gif')}});
                                    @case('10n')        background: url({{asset('images/w_rain.gif')}});
                                    @case('11d')        background: url({{asset('images/w_thunder_storm.gif')}});
                                    @case('11n')        background: url({{asset('images/w_thunder_storm.gif')}});
                                    ...
                                    @case('50d')        background: url({{asset('images/w_mist.gif')}});
                                    @case('50n')        background: url({{asset('images/w_mist.gif')}});
